...
def main() -> None:
    ...
    require(introduction["wordCount"] == 289, "unexpected self-introduction word count")
    require(len(introduction["words"]) == 289, "self-introduction word list mismatch")
    ...
    report = [
        ...
        "- The self-introduction player provides 289 word-level British IPA annotations and bundled en-GB-RyanNeural male audio.",
        "",
    ]
